...
import { LayoutDashboard, Users, ArrowRightLeft, Percent, ChevronLeft, ChevronRight, Menu } from 'lucide-react'; // Changed TicketPercent to Percent
...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { href: '/admin/coupons', icon: Percent, label: 'Cupones' }, // Changed TicketPercent to Percent
  ];
